...
public class PreperationTimeWithLikeExperiment {
  ...
  public PreperationTimeWithLikeExperiment(
  ...
  public void run() throws IOException {
    ...
    problemList.add(
        new ExperimentProblem<>(
            new DietProblemPermutation(
                "DietProblemLongPreperationTimeLikePreference",
                age,
                gender,
                "experiment_long_preperation_time_like_preference.fcl")));
    problemList.add(
        new ExperimentProblem<>(
            new DietProblemPermutation(
                "DietProblemShortPreperationTimeDontLikePreference",
                age,
                gender,
                "experiment_short_preperation_time_dont_like_preference.fcl")));
    ...
    Experiment<PermutationSolution<Integer>, List<PermutationSolution<Integer>>> experiment =
        new ExperimentBuilder<PermutationSolution<Integer>, List<PermutationSolution<Integer>>>(
                "PreperationTimeWithLikeExperiment")
